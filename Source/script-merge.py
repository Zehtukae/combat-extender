...
with open("P5-Gustav-Character.txt", "r") as file1, open("P5-GustavDev-Character.txt", "r") as file2, open("P5-Shared-Character.txt", "r") as file3, open("P5-SharedDev-Character.txt", "r") as file4:
...
with open("merged_file_p5.txt", "w") as merged_file:
